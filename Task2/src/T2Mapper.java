...
public class T2Mapper extends TableMapper<ImmutableBytesWritable, ImmutableBytesWritable> {
	...
	public void map(ImmutableBytesWritable key, Result value, Context context) throws IOException, InterruptedException {
		...
		if(ts.after(timeStart) && ts.before(timeEnd)){
			...
			context.write(new ImmutableBytesWritable(artid), new ImmutableBytesWritable(revid));
		}
	}
}
