...
public class Task3B extends Configured implements Tool {
	...
	public int run(String[] arg) throws Exception{
		...
		//Point to Jar
		conf.set("mapred.jar", "file:///users/level4/1002386c/Documents/BD4/AE2/Q3B.jar");
	...
	public static void main(String[] args) throws Exception{
		System.exit(ToolRunner.run(new Task3B(), args));
	}
}
